...
$feed_max_items = '10';
$date_format = '%d %B %Y';
$error_title = 'Ooops, mais ce n&#8217;est pas ici!';
$error_text = 'Vraiment désolé, mais ce que vous cherchez ne se trouve pas ici. Cliquez sur le bouton ci-dessous pour trouver autre chose qui pourrait vous intéresser.';
